...
<?php 
	if (isset($_GET['submit'])) {
		...
		try {
			//Ejecutamos SQl
			$resultado = UsuarioBLL::actualizar($usuario);
		} catch (Exception $ex) {
		...
		echo '<p class="text-right">
			     ...
			     <span class="glyphicon glyphicon-edit"></span>Editar Otro Usuario</a>
			  </p>';
		return;
	}
	...
	if (isset($_GET['modificar'])) {
		...
		<form class="form-horizontal" role="form" method="get">
			<input type="hidden" name="view" id="view" value="modificar_usuario">
