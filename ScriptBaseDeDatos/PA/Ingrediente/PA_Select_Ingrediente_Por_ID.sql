...
drop procedure if exists PA_S_Ingrediente_Por_ID;

DELIMITER //
create procedure PA_S_Ingrediente_Por_ID(pID varchar(6), out msg_error varchar(100))

bloquePrincipal:
begin
	
	-- Declaración de variables locales
	declare nombre_PA varchar(30) default '[PA_S_Ingrediente_Por_ID]';
